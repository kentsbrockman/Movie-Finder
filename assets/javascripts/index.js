...
// We reload the articles depending of the currentKeywords
// TODO: Modify this function to display only articles that contain at least one of the selected keywords.
const reloadArticles = () => {
    document.querySelector('.articlesList').innerHTML = '';
    
    const articlesToShow = data.articles.filter((article) => article[filter] === currentKeywords[0]);
...
// TODO: If a keyword is already in the list of present hashtags (checkbox list), we don't show it.
